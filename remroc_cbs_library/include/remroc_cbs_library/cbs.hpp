...
namespace remroc_cbs_library {
  ...
  std::unordered_map<int, std::vector<std::vector<int>>> get_robots_waypoint_array(std::string mapf_config_file, std::unordered_map<int, std::vector<std::vector<int>>> input_map);
